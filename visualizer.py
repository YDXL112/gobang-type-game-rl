...
def main():
    ...
    parser.add_argument("--json_path", type=str, default="results/run_a2c.json", help="Path to results JSON")
    parser.add_argument("--episode", type=int, default=900, help="Episode index to visualize")
