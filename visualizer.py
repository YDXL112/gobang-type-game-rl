...
def main():
    ...
    parser.add_argument("--json_path", type=str, default="results/run5.json", help="Path to results JSON")
    parser.add_argument("--episode", type=int, default=1000, help="Episode index to visualize")
